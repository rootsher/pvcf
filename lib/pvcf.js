...
define('pvcf', ['when', 'node', 'callbacks'], function pvcf(when, nodefn, callbacks) {
     ...
     * @param {Tab} tab
     */
    function Navigation(patternManager, view, tab) {
     ...
     * @method
     */
    Navigation.prototype._mainHandler = function _mainHandler() {
        ...
        if (hash) {
            patternData = this._patternManager.resolveHash(hash);
        ...
        this._tab.openView(view, params);
    };
     ...
     * @method
     */
    Navigation.prototype.listenHashChange = function listenHashChange() {
        window.addEventListener('hashchange', this._mainHandler.bind(this));
    };
     ...
     * @method
     */
    Navigation.prototype.listenClickAction = function listenClickAction() {};
